...
We use these classes to derive a ranking for the post so it knows how high up it should show in the feed. You can calculate the ranking of the post by accessing the object properties.
