...
If you write your own function be sure it follows the same structure as the one shown [computeRanking](https://github.com/elijahleinkram/jasper/blob/master/ranking/compute_ranking). 
