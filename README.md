...
You can write your own function, but the template used must be identical to [this](https://github.com/elijahleinkram/feed-samples/blob/master/ranking/computeRanking). Else, it will not work.
