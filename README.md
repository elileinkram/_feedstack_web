...
Right now [Jasper](https://play.google.com/store/apps/details?id=com.jasper.jasper) is only available on android devices. But that is quickly changing. Our ios version will be ready by early next week.
