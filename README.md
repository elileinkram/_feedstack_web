...
You can write your own functions, but the layout should look like [this](https://github.com/elijahleinkram/feed-samples/blob/master/ranking/compute_ranking).
