...
We use these classes to derive a ranking for the post so it knows where it should go in the feed. The calculation is performed inside the [computeRanking](https://github.com/elijahleinkram/feed-samples/edit/master/ranking/computeRanking) function. 
