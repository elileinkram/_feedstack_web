...
You can write your own functions, but the layout should look something like [this](https://github.com/elijahleinkram/feed-samples/blob/master/ranking/compute_ranking). You can then upload the function to the app.To get started, watch this clip [these directions](https://j.gifs.com/K1pmOx.gif).
