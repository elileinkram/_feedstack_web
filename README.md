...
You can write your own function, but the template must be the same as [this](https://github.com/elijahleinkram/feed-samples/blob/master/ranking/computeRanking). Else, it will not work. Look at the examples, if you are confused by this.
