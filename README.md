...
[Jasper](https://play.google.com/store/apps/details?id=com.jasper.jasper) sends the posts to [computeRanking](https://github.com/elijahleinkram/jasper/blob/master/ranking/compute_ranking) to calculate the rankings.
